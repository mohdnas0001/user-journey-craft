...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-foreground text-background" ref={ref}>
      <div className="section-container">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <a
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-background text-foreground rounded-full hover:bg-background/90 transition-colors"
            >
            ...
            <a
              ...
              className="group flex items-center gap-3 px-8 py-4 border border-background/30 rounded-full hover:bg-background/10 transition-colors"
            >
        ...
        >
          <p>© 2024 — Designed with purpose</p>
